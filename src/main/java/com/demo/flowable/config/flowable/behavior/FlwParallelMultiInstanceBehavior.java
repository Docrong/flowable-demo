...
import com.demo.flowable.utils.FlowableUtils;
 ...
 */
@Slf4j
public class FlwParallelMultiInstanceBehavior extends ParallelMultiInstanceBehavior {


    public FlwParallelMultiInstanceBehavior(Activity activity,
    ...
    protected int resolveNrOfInstances(DelegateExecution execution) {
        ...
        // 第二步，获取任务的所有处理人
        Set<String> assigneeUserIds = CollUtil.newHashSet("1");
